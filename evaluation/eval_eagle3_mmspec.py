"""EAGLE3 speculative decoding evaluation for MMSpec unified dataset.

Usage:
python -m evaluation.eval_eagle3_mmspec --base-model-path <path> --spec-model-path <path> --data-folder <path>
"""
...
from method.eagle3.kv_cache import initialize_past_key_values
from method.eagle3.utils import *
from method.eagle3.spec_model import SpecModel  # EAGLE3 SpecModel
...
def evaluate(args):
    """Run EAGLE3 speculative decoding evaluation on MMSpec dataset."""
    # Load model
...
def main():
    parser = argparse.ArgumentParser(description="EAGLE3 evaluation for MMSpec")
    parser = get_common_args(parser)
    
    # EAGLE3 specific args
    parser.add_argument(
        "--total-token",
        type=int,
        default=30,
    ...
    args.model_id = args.model_id + "-eagle3-temperature-" + str(args.temperature)
    ...
    print("Method: EAGLE3 (Speculative Decoding)")
