...
Usage:
python -m evaluation.eval_eagle_mmspec --base-model-path <path> --spec-model-path <path> --data-folder <path>
"""
...
from method.eagle.kv_cache import initialize_past_key_values
from method.eagle.utils import *
from method.eagle.spec_model import SpecModel  # Standard EAGLE SpecModel
...
def evaluate(args):
    """Run EAGLE speculative decoding evaluation on MMSpec dataset."""
    # Load model
...
def main():
    parser = argparse.ArgumentParser(description="EAGLE evaluation for MMSpec")
    ...
    args.model_id = args.model_id + "-eagle-temperature-" + str(args.temperature)
    ...
    print("Method: EAGLE (Standard Speculative Decoding)")
