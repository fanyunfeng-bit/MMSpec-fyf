...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def _update_causal_mask(
        ...
        # )
        past_seen_tokens = (
            past_key_values[0][0].current_length if past_key_values is not None and len(past_key_values) > 0 else 0
        )  # [MODIFIED]
    ...
    def forward(
        ...
        if position_ids is None and (
            ...
            if (
                ...
                or (
                    past_key_values is None or len(past_key_values) == 0 or past_key_values[0][0].current_length == 0
                )  # [MODIFIED]
            ):
