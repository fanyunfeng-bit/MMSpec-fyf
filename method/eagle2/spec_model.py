...
class SpecModel(nn.Module):
    ...
    def from_pretrained(
        ...
        **kwargs,
            ...
            while True:
                ...
                if not os.path.exists(shard_path):
                    try:
                        ...
                        break
                print(f"[eagle2] Merging shard: {shard_name}")
        ...
        if is_eagle3_ckpt:
            print(
                f"[eagle2] Detected EAGLE3-style checkpoint in '{spec_model_path}'. "
                "Using EAGLE3 Model class with EAGLE2 inference."
            )
        ...
        **kwargs,
        ...
        with torch.inference_mode():
            ...
            if self.is_eagle3_ckpt:
                ...
                # Zero out hidden states at image token positions (same as eagle).
