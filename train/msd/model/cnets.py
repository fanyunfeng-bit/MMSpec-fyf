...
from train.msd.model.choices import *
from train.msd.model.utils import prepare_logits_processor
...
class Model(nn.Module):
    def __init__(self, config, load_emb=False, path=None, bias=True, total_tokens=63, depth=5, top_k=8, threshold=1.0, train_embed=False, decouple=False):
        ...
        if load_emb:
            from train.msd.main_deepspeed import get_embed
        ...
        from train.msd.model.ea_llama_model import LlamaDecoderLayer
        from train.msd.model.ea_qwen2vl_model import Qwen2VLDecoderLayer, Qwen2VLRotaryEmbedding
    ...
    def forward(
        ...
        # with torch.no_grad():
        from train.msd.model.utils import temp_cache
